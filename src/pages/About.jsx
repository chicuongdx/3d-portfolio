  ...
  return (
    <section className="max-container">
      <h1 className='head-text'>
        Hey, I'm <span className='blue-gradient_text font-semibold drop-shadow'>Cường</span>
      </h1>
      <div className='mt-5 flex flex-col gap-3 text-slate-500'>
        <p>
          A versatile AI Engineer based in Vietnam. With a strong foundation in machine learning, deep learning, computer vision, and natural language processing.
